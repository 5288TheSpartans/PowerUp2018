...
public class RobotMap {
	...
	//0.009, 0, 0.001, 1/720
	public static double StraightP = 0.02;
	public static double StraightI = 0.000;
	public static double StraightD = 0.04;
	public static double StraightFF = 0.0; // 1/360
	// DriveDistance PID values
	//1/7,0.4,0.24,0
	public static double DistanceP = 0.035;
	public static double DistanceI = 0.0;
	public static double DistanceD = 0.00;
	public static double DistanceFF = 0.0;
	...
	public static double LiftP = 0.1;
	public static double LiftI = 0;
	public static double LiftD = 0.00;
