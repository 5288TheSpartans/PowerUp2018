 ...
 *
 */
public class autoNoIntakeCubeLeftSideToLeftSwitch extends CommandGroup {

    public autoNoIntakeCubeLeftSideToLeftSwitch() {
    	// This should knock a cube mounted on top of the ramps
    	// Into the switch. 
    	...
    	addSequential(new DriveStraightTime(3000));
